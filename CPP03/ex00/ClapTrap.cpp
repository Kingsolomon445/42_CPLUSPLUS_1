...
ClapTrap::ClapTrap(): _hitP(10), _energyP(10), _attackD(0), _name("nameless"), _type("ClavTrap")
{
    std::cout << "ClapTrap default constructor has been called" << std::endl;
}

ClapTrap::ClapTrap(std::string name): _hitP(10), _energyP(10), _attackD(0), _name(name), _type("ClavTrap")
{
